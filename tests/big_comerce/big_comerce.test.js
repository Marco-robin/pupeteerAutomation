...
describe('Aviator Test', () => {
    ...
    describe('Select subscriber test', () => {
      ...
      test('Big Commerce', async()=>{
        ...
        await page.waitForSelector(selector.bigComerce_main);
        await page.click(selector.bigComerce_main);
        await page.waitForSelector(selector.ordersBC_dropdown);
        await page.click(selector.ordersBC_dropdown);
      ...
      test('Big Commerce orders', async()=>{
        ...
        await page.waitForSelector(selector.ordersBC_dropdown);
        await page.click(selector.ordersBC_dropdown);
        await page.waitForSelector(selector.BGtable);
        var welcomeTxt = await page.$$eval(selector.BGtable,
          elements=> elements.map(item=>item.textContent));       
        await expect(welcomeTxt[0]).toContain('');
